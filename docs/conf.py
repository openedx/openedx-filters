...
"""
openedx-filters documentation build configuration file.
...
project = "openedx-filters"
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = "openedx-filters"
...
html_context = {
    ...
    "github_repo": "openedx-filters",  # Repo name
...
#
# html_title = 'openedx-filters v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call(
        [
            ...
            "-o",
            docs_path,
            os.path.join(root_path, "openedx_filters"),
            os.path.join(root_path, "openedx_filters/migrations"),
        ]
    )
